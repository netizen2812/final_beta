    ...
    return (
        <div className="w-[280px] flex flex-col h-full overflow-hidden bg-white/70 backdrop-blur-md border-l border-slate-100/80">
            ...
            <div className="p-5 border-b border-slate-100/80">
                ...
                <p className="text-[10px] text-slate-400 font-medium mt-0.5">{t('chat.customizeAI')}</p>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-7 no-scrollbar">
                ...
                <div className="space-y-3">
                    <p className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">{t('chat.schoolOfThoughtShort')}</p>
                ...
                {/* Tone Selector */}
                <div className="space-y-3">
                    <p className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">{t('chat.currentMood')}</p>
                    <div className="space-y-1.5">
                        {toneOptions.map((t) => (
                            <button
                                key={t.label}
