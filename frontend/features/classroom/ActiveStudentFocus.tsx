...
export const ActiveStudentFocus: React.FC<ActiveStudentFocusProps> = ({
  ...
  return (
    <div 
        ...
        className={`flex-1 rounded-[2.5rem] border border-emerald-900/40 shadow-2xl overflow-hidden relative group flex flex-col md:flex-1 transition-all duration-700 pointer-events-none ${!activeChildId ? 'opacity-0 scale-95 pointer-events-none' : 'opacity-100 scale-100'}`} 
