...
const TarbiyahLearning: React.FC = () => {
  ...
  if (children.length === 0) return (
    <div className="min-h-screen bg-[#022c22] flex flex-col items-center justify-center p-10 text-center space-y-8 animate-in fade-in">
      ...
      <div>
        <h2 className="text-3xl font-serif font-bold text-white">No Traveler Profiles</h2>
        <p className="text-emerald-100/40 mt-4 max-w-xs mx-auto text-sm leading-relaxed">Visit the Profile tab to create a profile for your child and begin their learning adventure.</p>
      </div>
    </div>
  );
